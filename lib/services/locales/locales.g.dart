...
class _$LocaleEnUS extends _$LocaleBase {
  ...
  Map<String, String> get data => {
    ...
    "app_page.download_dialog_description": "If you are sure you want to install this application press Yes, otherwise press No.",
    ...
    "app_page.donate_dialog_description": "If you wish to support the development of the application, please click on the donation links below.",
    ...
    "app_page.long_description_content": "Insert application description here.",
...
class _$LocaleHrHR extends _$LocaleBase {
  ...
  Map<String, String> get data => {
    ...
    "app_page.download_dialog_description": "Ako ste sigurni da želite instalirati ovu aplikaciju pritisnite Da, u suprotnom pritisnite Ne.",
    ...
    "app_page.donate_dialog_description": "Ako želite podržati razvoj aplikacije, kliknite na linkove za donacije u nastavku.",
